...
public class firstSwing extends JFrame implements ActionListener{
	...
	public firstSwing() 
	{
		...
		jlbOutput.setBackground(Color.green);
...
//		GridLayout(int rows, int cols, int hgap, int vgap) 
		...
		jbnButtons[21] = new JButton("Cos");
		
		jplBackSpace = new JPanel();
		jplBackSpace.setLayout(new GridLayout(1, 1, 2, 2));

		jbnButtons[22] = new JButton("Backspace");
		jplBackSpace.add(jbnButtons[20]);

		jplControl = new JPanel();
		jplControl.setLayout(new GridLayout(1, 2, 2 ,2));

		jbnButtons[23] = new JButton(" CE ");
		jbnButtons[24] = new JButton("C");
...
//		Setting all Numbered JButton's to Blue. The rest to Red
	...
	public static void main(String args[]) {
		firstSwing calci = new firstSwing();
