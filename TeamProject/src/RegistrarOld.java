...
final static int PASSWORD = 12345;
	...
	public static void main(String[] args) {
		...
		System.out.println("Hello. Welcome to the GW Corse Regestration System."); 
    	System.out.println("Please Chose from the Following otions");
    	   do {
